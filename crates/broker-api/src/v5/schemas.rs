...
static CONNECTORS_SCHEMA: LazyLock<Value> = LazyLock::new(|| {
    ...
    // 1. Redis
    schemas.insert("redis.post_connector".to_string(), obj_schema_with_type("redis", json!({
    ...
    // 3. Kafka Consumer
    schemas.insert("kafka_consumer.post_connector".to_string(), obj_schema(json!({
        "bootstrap_hosts": str_prop("127.0.0.1:9092"),
    ...
    // 4. PostgreSQL (pgsql)
    schemas.insert("connector_postgres.post_connector".to_string(), obj_schema_with_type("pgsql", json!({
    ...
    // 5. MySQL
    schemas.insert("bridge_mysql.post_connector".to_string(), obj_schema_with_type("mysql", json!({
    ...
    // 6. HTTP Webhook
    schemas.insert("bridge_http.post_connector".to_string(), obj_schema_with_type("http", json!({
    ...
    // 7. ClickHouse
    schemas.insert("bridge_clickhouse.post_connector".to_string(), obj_schema_with_type("clickhouse", json!({
    ...
    schemas.insert("connector_mqtt.post_connector".to_string(), obj_schema_with_type("mqtt", json!({
    ...
    // 9. MongoDB
    schemas.insert("bridge_mongodb.post_connector".to_string(), obj_schema_with_type("mongodb", json!({
    ...
    // 10. Cassandra
    schemas.insert("bridge_cassa.post_connector".to_string(), obj_schema(json!({
    ...
    // 11. RabbitMQ
    schemas.insert("rabbitmq.post".to_string(), obj_schema(json!({
    ...
    // 12. Pulsar
    schemas.insert("pulsar.post".to_string(), obj_schema(json!({
        "servers": str_prop("pulsar://127.0.0.1:6650"),
        "ssl": ssl_prop()
    }), &["name", "servers"]));

    // 13. Amazon S3
    schemas.insert("bridge_s3.post_connector".to_string(), obj_schema(json!({
    ...
    schemas.insert("connector_azure_blob_storage.post_connector".to_string(), obj_schema(json!({
    ...
    // 15. InfluxDB
    schemas.insert("bridge_influxdb.post_connector".to_string(), obj_schema(json!({
    ...
    // 16. TimescaleDB
    schemas.insert("bridge_timescale.post_connector".to_string(), obj_schema(json!({
        "server": str_prop("127.0.0.1:5432"),
    ...
    // 17. TDengine
    schemas.insert("tdengine_connector.post".to_string(), obj_schema(json!({
    ...
    // 18. OpenTSDB
    schemas.insert("opents_connector.post".to_string(), obj_schema(json!({
        "server": str_prop("http://127.0.0.1:4242"),
        "summary": str_prop("")
    }), &["name", "server"]));

    // 19. IoTDB
    schemas.insert("iotdb.post_restapi".to_string(), obj_schema(json!({
        "base_url": str_prop("http://127.0.0.1:18080"),
        "username": str_prop("root"),
        "password": pwd_prop()
    }), &["name", "base_url"]));
    schemas.insert("iotdb.post_thrift".to_string(), obj_schema(json!({
    ...
    // 20. GreptimeDB
    schemas.insert("bridge_greptimedb.post_connector".to_string(), obj_schema(json!({
    ...
    // 21. Elasticsearch
    schemas.insert("elasticsearch.post".to_string(), obj_schema(json!({
    ...
    // 22. DynamoDB
    schemas.insert("bridge_dynamodb.post_connector".to_string(), obj_schema(json!({
    ...
    // 23. Kinesis
    schemas.insert("bridge_kinesis.post_connector".to_string(), obj_schema(json!({
    ...
    // 24. Confluent
    schemas.insert("confluent.post_connector".to_string(), obj_schema(json!({
        "bootstrap_hosts": str_prop(""),
        "ssl": ssl_prop()
    }), &["name", "bootstrap_hosts"]));

    // 25. Redshift
    schemas.insert("connector_redshift.post_connector".to_string(), obj_schema(json!({
    ...
    // 26. BigQuery
    schemas.insert("connector_bigquery.post_connector".to_string(), obj_schema(json!({
        "gcp_project_id": str_prop(""),
        "service_account_json": pwd_prop()
    }), &["name", "gcp_project_id"]));

    // 27. Couchbase
    schemas.insert("connector_couchbase.post_connector".to_string(), obj_schema(json!({
    ...
    // 28. RocketMQ
    schemas.insert("rocketmq.post_connector".to_string(), obj_schema(json!({
    ...
    // 29. Oracle
    schemas.insert("bridge_oracle.post_connector".to_string(), obj_schema(json!({
    ...
    schemas.insert("bridge_mssql.post_connector".to_string(), obj_schema(json!({
    ...
    schemas.insert("bridge_sqlserver.post_connector".to_string(), obj_schema(json!({
        "server": str_prop("127.0.0.1:1433"),
        "database": str_prop("master"),
        "username": str_prop("sa"),
        "password": pwd_prop(),
    ...
    // 31. CockroachDB
    schemas.insert("connector_cockroachdb.post_connector".to_string(), obj_schema(json!({
    ...
    // 32. Doris
    schemas.insert("connector_doris.post_connector".to_string(), obj_schema(json!({
    ...
    // 33. Tablestore
    schemas.insert("bridge_tablestore.post_connector".to_string(), obj_schema(json!({
        "endpoint": str_prop(""),
    ...
    schemas.insert("connector_aws_timestream.post_connector".to_string(), obj_schema(json!({
        "region": str_prop("us-east-1"),
        "database": str_prop(""),
        "access_key_id": str_prop(""),
        "secret_access_key": pwd_prop()
    ...
    // 35. GCP Pub/Sub
    schemas.insert("gcp_pubsub_producer.post_connector".to_string(), obj_schema(json!({
        "gcp_project_id": str_prop(""),
        "service_account_json": pwd_prop()
    }), &["name", "gcp_project_id"]));
    schemas.insert("gcp_pubsub_consumer.post_connector".to_string(), obj_schema(json!({
        "gcp_project_id": str_prop(""),
        "service_account_json": pwd_prop()
    }), &["name", "gcp_project_id"]));

    // 36. Azure Event Hubs
    schemas.insert("bridge_azure_event_hub.post_connector".to_string(), obj_schema(json!({
        "connection_string": pwd_prop()
    }), &["name", "connection_string"]));

    // 37. Snowflake
    schemas.insert("connector_snowflake_aggregated.post_connector".to_string(), obj_schema(json!({
        "account": str_prop(""),
        "database": str_prop(""),
        "schema": str_prop(""),
        "username": str_prop(""),
    ...
    schemas.insert("connector_snowflake_streaming.post_connector".to_string(), obj_schema(json!({
        "account": str_prop(""),
        "database": str_prop(""),
        "schema": str_prop(""),
        "username": str_prop(""),
    ...
    // 38. AlloyDB
    schemas.insert("connector_alloydb.post_connector".to_string(), obj_schema(json!({
        "server": str_prop("127.0.0.1:5432"),
        "database": str_prop("postgres"),
        "username": str_prop("postgres"),
        "password": pwd_prop(),
    ...
    // 39. Disk Log
    schemas.insert("connector_disk_log.post_connector".to_string(), obj_schema(json!({
        "file": str_prop("data/disk_log.txt")
    }), &["name", "file"]));

    // 40. S3 Tables
    schemas.insert("connector_s3tables.post_connector".to_string(), obj_schema(json!({
    ...
    // 41. Datalayers
    schemas.insert("bridge_datalayers.post_connector".to_string(), obj_schema(json!({
    ...
    // 42. SysKeeper
    schemas.insert("syskeeper_forwarder.post".to_string(), obj_schema(json!({
        "server": str_prop("127.0.0.1:9000")
    }), &["name", "server"]));
    schemas.insert("connector_syskeeper_proxy.post".to_string(), obj_schema(json!({
...
static ACTIONS_SCHEMA: LazyLock<Value> = LazyLock::new(|| {
    ...
    // Redis action
    schemas.insert("redis.post_bridge_v2".to_string(), obj_schema_with_type("redis", json!({
        "connector": str_prop(""),
        "command": json!({
            "type": "array",
            "items": { "type": "string" },
    ...
    // Kafka action
    schemas.insert("bridge_kafka.post_bridge_v2".to_string(), obj_schema_with_type("kafka", json!({
        "connector": str_prop(""),
    ...
    // HTTP action
    schemas.insert("bridge_http.post_bridge_v2".to_string(), obj_schema_with_type("http", json!({
        "connector": str_prop(""),
    ...
    // MQTT action
    schemas.insert("bridge_mqtt_publisher.post_bridge_v2".to_string(), obj_schema_with_type("mqtt", json!({
        "connector": str_prop(""),
